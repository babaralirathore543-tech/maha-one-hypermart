...
type ShippingZone = keyof typeof SHIPPING_RATES;
      ...
      <div className="min-h-[60vh] flex items-center justify-center bg-[#FFFDF7] dark:bg-[#111827] px-4">
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm sm:text-base">
            Start shopping for premium products!
          </p>
          <Link
            to="/shop"
            className="inline-block mt-6 bg-[#D4AF37] text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold hover:bg-[#b8941f] transition shadow-lg hover:shadow-xl text-sm sm:text-base active:scale-95"
          >
            Shop Now
          </Link>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2 space-y-3 sm:space-y-4">
            {cart.map((item: any) => (
              ...
              >
                {/* Product Image */}
                <div className="w-16 h-16 sm:w-20 sm:h-20 shrink-0 rounded-xl overflow-hidden bg-[#F8FAFC] dark:bg-[#1F2937] border border-gray-100 dark:border-gray-700">
                  <img
                    src={item.image}
                    alt={item.name}
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src =
                        'https://via.placeholder.com/80x80/D4AF37/FFFFFF?text=Product';
                    }}
                  />
                </div>
                ...
                <div className="flex-1 min-w-0 w-full sm:w-auto">
                  ...
                  {/* Variant info (size, colour) */}
                  {(item.size || item.colour || item.weight) && (
                  ...
                  <p className="text-[#D4AF37] font-bold text-sm sm:text-base mt-1">
                  ...
                  <div className="flex items-center gap-1 sm:gap-2 mt-1.5 sm:mt-2 flex-wrap">
                    <button
                      ...
                      className="p-1.5 sm:p-2 rounded-full hover:bg-[#F8FAFC] dark:hover:bg-gray-700 transition border border-gray-200 dark:border-gray-600 active:scale-95"
                    ...
                    <button
                      ...
                      className="ml-1 sm:ml-2 p-1.5 sm:p-2 text-red-500 hover:text-red-700 dark:hover:text-red-400 transition hover:bg-red-50 dark:hover:bg-red-900/20 rounded-full active:scale-95"
          ...
          {/* ============================================================
              ORDER SUMMARY
          ============================================================ */}
          <div className="bg-white/80 dark:bg-[#1F2937]/80 backdrop-blur p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border border-[#E5E7EB] dark:border-gray-700 h-fit lg:sticky lg:top-24 shadow-sm">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 dark:text-gray-400 flex items-center gap-1.5">
                    <FaTruck className="text-[#0F766E]" size={12} />
                    Shipping
                  </span>
                  <span className="font-semibold text-[#111827] dark:text-white">
                    PKR {shipping}
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      type="button"
                      onClick={() => setSelectedZone('karachi')}
                      className={`py-2 px-2 rounded-lg text-xs font-medium transition border-2 ${
                        selectedZone === 'karachi'
            ...
            {/* Coupon — REMOVED (dead code) */}

            {/* ✅ Checkout Button — pass zone */}
            <Link
              to="/checkout"
              state={{ shipping, selectedZone }}
              className="w-full mt-4 sm:mt-5 md:mt-6 bg-[#0F766E] text-white py-3 sm:py-3.5 rounded-xl font-semibold text-center hover:bg-[#065F46] transition flex items-center justify-center gap-2 text-sm sm:text-base active:scale-95"
            >
              Proceed to Checkout <FaArrowRight className="text-xs sm:text-sm" />
            </Link>

            {/* Trust badges */}
            <div className="grid grid-cols-3 gap-2 mt-4 pt-4 border-t border-[#E5E7EB] dark:border-gray-700">
              <div className="text-center">
                <FaTruck className="text-[#D4AF37] mx-auto text-sm" />
                <p className="text-[10px] text-gray-500 mt-1">Fast Delivery</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-[10px] text-gray-500 mt-1">Verified</p>
              </div>
            </div>
          </div>
        </div>
