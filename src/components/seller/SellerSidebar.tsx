...
const SellerSidebar = ({ sellerDocId }: SellerSidebarProps) => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-[#0F766E] to-[#065F46] shadow-xl flex flex-col">
      ...
      <div className="p-4 border-t border-teal-700">
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 w-full rounded-lg text-teal-100 hover:bg-teal-700/50 hover:text-white transition-all duration-200"
        >
          <LogOut size={20} />
          <span>Logout</span>
        </button>
