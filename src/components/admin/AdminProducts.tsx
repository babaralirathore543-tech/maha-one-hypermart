    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
          <div className="relative flex-1 sm:flex-initial">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#0F766E] outline-none w-full sm:w-56 text-sm"
            />
          </div>
          <button
            onClick={() => navigate('/admin/products/add')}
            className="bg-[#0F766E] text-white px-4 py-2 rounded-lg hover:bg-[#065F46] transition flex items-center gap-2 text-sm whitespace-nowrap"
          >
            <FaPlus /> Add Product
          </button>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          ...
          <p className="text-sm text-gray-500">Loaded Variants</p>
          <p className="text-[10px] text-gray-400 mt-0.5">Expand to load</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          <p className="text-2xl font-bold text-green-600">
            {
              new Set(
                Object.values(variantCache)
                  .flat()
                  .map((v) => v.colour)
              ).size
            }
                        ...
                        <td className="py-3 px-4">
                          <div className="flex gap-1">
                            <button
                              onClick={() =>
                                navigate(
                                  `/admin/products/edit/${product.category}/${product.id}`
                                )
                              }
